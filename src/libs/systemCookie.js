...
const PublicKey = 'ScmPublicKey'; // 公钥
const AccountKey = 'ScmAccount'; // 账户名
const PwdKey = 'ScmEncrypt'; // 账户密码（已加密）
const AccessTokenKey = 'ScmAuthorization'; // 用户 token
const RefreshTokenKey = 'ScmRefreshToken'; // refreshKey

const UserInfoKey = 'ScmUserInfo'; // 用户信息
