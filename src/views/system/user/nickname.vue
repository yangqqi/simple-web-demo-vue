// @物流系统/个人中心/修改昵称
<template>
    <div class="system_user_nickname">
        <div class="weui-form">
            <div class="weui-form__control-area">
                <div class="weui-cells__group weui-cells__group_form">
                    <div class="weui-cells weui-cells_form">
                        <div class="weui-cell weui-cell_active">
                            <div class="weui-cell__hd"><label class="weui-label">新昵称</label></div>
...
export default {
    ...
    computed: {
        ...mapState(['userInfo']),
        disabled: function() {
            return !this.nickname || !this.userInfo;
        }
    },
    mounted() {
    ...
    methods: {
        ...
        handleSubmit() {
            ...
            if (this.userInfo.userName === this.nickname) {
                this.$weui.topTips('该昵称与当前昵称相同');
                ...
                this.isLoading = true;
                this.$systemAxios
                    .postParams('/api/scm/account/updateName', {
                        name: this.nickname
                    })
                    .then(res => {
