...
export default {
    ...
    computed: {
        ...mapState(['memberInfo']),
        disabled: function() {
            return !this.areaCode || !this.phone || !this.verifiCode || !this.memberInfo;
        },
        vcDisabled: function() {
    ...
    mounted() {
        ...
        this.areaCode = this.memberInfo.areaCode;
    },
    beforeDestroy() {
        if (this.timer) {
    ...
    methods: {
        ...
        onGetVerifiCode() {
            ...
            if (this.memberInfo.phone === this.phone && this.memberInfo.areaCode === this.areaCode) {
        ...
        handleGetVerifiCode() {
            ...
            this.$memberAxios.post('/api/scm/member/base/sendVcode', {
        ...
        handleSubmit() {
            ...
            this.isLoading = true;
            this.$memberAxios
                .post('/api/scm/member/base/updatePhone', {
                    areaCode: this.areaCode,
                    phone: this.phone,
